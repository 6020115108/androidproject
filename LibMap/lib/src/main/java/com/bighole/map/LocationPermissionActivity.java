...
public class LocationPermissionActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        permissionHelper = LocationPermissionHelper.createForLocation(this);
        permissionHelper.setOnPermissionGranted(new LocationPermissionHelper.OnPermissionGranted() {
            @Override
            public void onPermissionGranted() {
                Intent intent = new Intent(LocationPermissionActivity.this, AfterPermissionActivity.class);
