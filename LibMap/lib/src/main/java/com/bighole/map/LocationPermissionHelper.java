...
public class LocationPermissionHelper {
     ...
     */
    public static LocationPermissionHelper createForLocation(Activity activity) {
        ...
        return new LocationPermissionHelper(activity, permissionHintMap, true);
    }
     ...
     */
    public LocationPermissionHelper(Activity activity, Map<String, String> permissionHintMap, boolean checkLocationEnabled) {
    ...
    private void onPermissionFail(final Activity activity, String[] fails, boolean isLocationConfigEnabled) {
        final Dialog dialog = new Dialog(activity, R.style.dialog_location);
        ...
        View v = LayoutInflater.from(activity).inflate(R.layout.loc_v_permission_fail, null, false);
